...
for t in loop supply lifecycle seed-interactive seed-agents seed-venues seed-reviews seed-events seed-profile; do $PSQL -d $DB -q -f "$ROOT/db/test/$t.sql" >/dev/null 2>&1; done
