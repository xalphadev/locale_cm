...
/** Deterministic photographic cover for a venue/quest (placeholder imagery; swap for real media later). */
export const cover = (seed: string, w = 640, h = 480) =>
  `https://picsum.photos/seed/${(seed || 'soihop').slice(0, 12)}/${w}/${h}`;
