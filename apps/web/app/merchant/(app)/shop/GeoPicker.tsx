      ...
      <div className="geopick-mapwrap">
        ...
        {ready && (
          <div className="geopick-pin" aria-hidden>
            <svg width="34" height="44" viewBox="0 0 24 32"><path d="M12 0C5.37 0 0 5.37 0 12c0 8.5 12 20 12 20s12-11.5 12-20C24 5.37 18.63 0 12 0z" fill="#3551D6" stroke="#fff" strokeWidth="1.5" /><circle cx="12" cy="12" r="4.4" fill="#fff" /></svg>
          </div>
        )}
