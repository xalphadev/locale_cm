...
| 6 | [06_ux_ui_design.md](06_ux_ui_design.md) | **UX/UI blueprint**: design system (Lanna-modern, "Soi Hop") + IA + ASCII wireframes (consumer/merchant/counter/agent) + hero flows | ~3,265 บรรทัด |
